...
var Particle = /*#__PURE__*/function () {
  function Particle(x, y, radius, color) {
    ...
    this.velocity = 0.05;
    this.disatanceFromCenter = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.randomIntFromRange)(50, 120);
    this.lastMouse = {
      x: x,
      y: y
    };
...
function init() {
  particles = [];
  for (var i = 0; i < 50; i++) {
    var radius = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.randomIntFromRange)(1, 2);
